...
RUN nmap 127.0.0.1 && nmap 127.0.0.1 -O && nmap 127.0.0.1 -sT && nmap 127.0.0.1 -p http,https && nmap 127.0.0.1 -sL && nmap 127.0.0.1 -sV && nmap 127.0.0.1 -f -oX /nmap/home/dast-report.txt cat /nmap/home/dast-report.txt
