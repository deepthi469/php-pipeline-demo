...
RUN curl -v -u dm-vic:Password123 --upload-file /nmap/home/dast-report.xml http://nexus3-openshift-operators.apps.vapo-ppd.va.gov/repository/dm-vic/dast-report.xml
